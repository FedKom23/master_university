...
### Дедлайны
**Soft Deadline - 1 октября в 23:59.**

**Hard Deadline - 8 октября в 23:59.**

### Формат сдачи
По аналогии с первым дз:
1. Нужно завести ветку `hw1` и вести свою разработку там.
2. Свою реализацию пропишите в файле `hw1/solution.py`, для вас уже готова заготовка класса.
3. Локально тесты можете запускать так:

    ```
   python -m pytest --log-cli-level INFO hw1/tests/
   ```
