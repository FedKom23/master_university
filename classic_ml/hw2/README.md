...
Задание проходит в формате kaggle competition. [Ссылка на соревнование.](https://www.kaggle.com/t/c911b58c33164aeeae26c90aea3b1658)
...
### Дедлайны
**Soft Deadline - 22 октября в 23:55.**

**Hard Deadline - 29 октября в 23:55.**
...
2. Нужно завести ветку `hw2` и добавлять свое решение в рамках нее.
3. Свою решение добавьте в директорию `hw2/`.
...
6. Как только считаете, что решение готово, заводите Merge Request из ветки `hw2` в `master`.
