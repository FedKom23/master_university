...
Задание проходит в формате kaggle competition. [Ссылка на соревнование.](https://www.kaggle.com/t/5aeaed5c13da4507857473c7eb30d62e)

## Как сдавать решение и в какой срок

### Дедлайн
В этом ДЗ будет только один дедлайн.
**Hard Deadline -- 25 ноября 23:55.**
...
2. Нужно завести ветку `hw3` и добавлять свое решение в рамках нее.
3. Свою решение добавьте в директорию `hw3/`.
...
6. Как только считаете, что решение готово, заводите Merge Request из ветки `hw3` в `master`.
