...
HINTS = {
    "test_kaggle_score": "Реши соревнование на kaggle, скор должен быть >= 0.25",
    "test_mlflow_exp": "Необходимо провести как минимум 3 валидных запуска в рамках одного эксперимента MLFLow",
    "test_labeling_interface": "Заполни необходимые пропуски в labeling_interface.xml",
    "test_s3_labelstudio": "Необходимо разметить минимум 5 примеров, данные разметки нужно экспортировать в S3"
}

SCORES = {
    "test_kaggle_score": 1,
    "test_mlflow_exp": 2,
    "test_labeling_interface": 1.5,
    "test_s3_labelstudio": 0.5
}
...
def pytest_sessionfinish(session, exitstatus):
    ...
    deadline = os.getenv("HW4_SOFT_DEADLINE", "")
